...
public class TravelAgency
{
    static void validate(int age, String gender) throws InvalidValueException
    {
        ...
        System.out.println("15% concession on rate is applicable!");
        else if(age>60 && gender.equals("female"))
        System.out.println("20% concession on rate is applicable!");
        else
        throw new InvalidValueException("Values not matching with norms of the agency!");
    }
